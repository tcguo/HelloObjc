...
@protocol YTExpandableCollectionViewDelegate <UICollectionViewDelegateFlowLayout>
...
@interface YTExpandableCollectionView : UICollectionView

/** The collection view’s delegate object. */
@property (nonatomic, assign) id <YTExpandableCollectionViewDelegate> delegate;
